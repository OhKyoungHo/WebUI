...
public class Using_NonRectangle_Array {
	...
	public static void main(String[] args) {
		...
		System.out.println("=======================================================");
		//2. 방법 2 : 비정방형 배열 선언시 값을 할당. 
		int [][] arr2 = new int[2][];	//비정방형 배열 선언 : 행의 갯수만 먼저 선언, 열은 선언하지 않음
		arr2 [0] = new int [] {1,2} ;	//0번째 행에 값을 바로 할당.(주의 : 방크기를 지정하면 오류)
		arr2 [1] = new int [] {3,4,5}; 	//1행의 값을 바로 할당.
		
		System.out.print(arr2[0][0] + " " + arr1[0][1]);
		System.out.println();
		System.out.print(arr2[1][0] + " " + arr1[1][1] + " " + arr1[1][2]);
		System.out.println();
		System.out.println("========================================================");
