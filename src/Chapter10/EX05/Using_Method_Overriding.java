...
//		- 동일한 메소드 이름에 시그니처가 다를 경우 다른 메소드로 식별하는 경우
...
//		   : 4. 접근제어자는 부모 클래스의 접근 제어자와 같거나 넓어야 한다.
...
class B extends A{		
	...
	@Override		//메소드 오버라이딩의 오류를 방지하는 설정
	void print() {	//메소드 오버라이딩 : 리턴 타입이 같고, 
