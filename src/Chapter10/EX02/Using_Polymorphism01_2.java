...
public class Using_Polymorphism01_2 {
	...
	public static void main(String[] args) {
		...
		//2. Person 객체 → Animal 타입생성
			// a2는 Animal, Person 타입을 내포하고 있고, Animal 타입으로 지정
			// Animal 타입의 필드, 메소드만 접근 가능, Person타입으로 다운 캐스팅이 가능
		Animal a2 = new Person();
		System.out.println(a2.name);
		
			//a2는 Person 타입으로 다운 캐스팅할 수 있다.(Animal, Person 필드, 메소드 모두 접근)
		Person p1 = (Person) a2;
		...
		System.out.println(p2.personName);
				//업캐스팅
		Animal a3 = p2;		//a3는 Animal, Person을 내포하고 있고, Animal타입으로 지정
		...
		//5. Person_person 객체를 Person_person 타입으로 생성
			//pp2는 Animal, Person, Person_person을 내포함. Person_person타입으로 지정됨
