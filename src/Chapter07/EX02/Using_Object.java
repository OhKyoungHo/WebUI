...
//class 외부에 올 수 있는 것(3가지) : 패키지, 임포트(같은 패키지에 존재하지 않는 클래스), 외부클래스

class A {	//클래스 : 객체를 생성하기 위한 설계도
	// 클래스 내부에 올 수 있는 것(4가지) : 1. 필드(클래스에서 선언된 변수), 2. 생성자, 3.메소드, 4.인너클래스
	// 1.필드 
	...
	// 		기본 생성자(입력매개변수가 없는 생성자)는 생략 될 수 있다. A () {}
	//		객체 생성시 생성자 호출 
	//		객체 초기값을 셋팅
	...
	String work4(String a) {			//String a -> return a-> String 
...
public class Using_Object {
	...
	public static void main(String[] args) {
		...
		//A() : 클래스 내부의 생성자 호출, 기본 생성자 : 입력 매개변수가 없는 생성자, 생략될 수 있다.
		...
		String s = a1.work4("안녕");				//리턴 값을 변수에 저장 후 출력
